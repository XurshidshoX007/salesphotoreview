const e=`<template>
  <side-menu
    ...
    variant="single"
    :data="data"
    :loading="cashboxStore.isCashboxesLoading"
    :classes="{
...
// Types
type Props = {
  data: (MenuBaseItem & AccessCashboxModel)[];
};
