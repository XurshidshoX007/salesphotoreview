...
<template>
  <div class="w-full">
    <div class="flex justify-center date_month">
      ...
      <p class="w-20 text-lg font-semibold text-center date_month_name">
        {{ months[currentMonth] }}
      </p>
    ...
    <div class="flex justify-between w-full space-x-4 date_picker pa">
      <div class="flex flex-col flex-1 space-y-1 day">
        ...
        <select
          class="px-1 py-2 border-2 rounded-md outline-none cursor-pointer day_picker"
          name="day_picker"
          id="day_picker"
        >
      ...
      <div class="flex flex-col flex-1 space-y-1 month">
        ...
        <select
          class="px-1 py-2 border-2 rounded-md outline-none cursor-pointer month_picker"
          name="month_picker"
          id="month_picker"
        >
    ...
    <div class="grid grid-cols-7 gap-2 py-2 week_days">
      <div class="text-sm font-medium text-center" v-for="weekDay in weekDays">
        {{ weekDay }}
      </div>
    </div>
    ...
    <div class="grid grid-cols-7 grid-rows-5 gap-2 month_days">
      <div
        class="col-start-4 px-5 py-4 font-semibold text-center rounded-lg cursor-pointer"
        @click="currentDay = monthDay"
        :style="
          monthDay == currentDay
            ? 'background: #269D97; color:white'
            : 'background: white'
        "
      >
        1
      ...
      <div
        class="w-[60px] h-[60px] font-semibold flex justify-center items-center transition rounded-[8px] cursor-pointer"
        @click="currentDay = monthDay"
        :style="
          monthDay == currentDay
            ? 'background: #269D97; color:white'
