  ...
  <div>
    <div class="table-content-container">
      <div class="table-content-header">
        ...
        />
        <search-input @change="currenciesStore.search" />
        <excel-btn
          @click="currenciesStore.onDownloadExcelFile"
          :loading="currenciesStore.isExcelFileDownloading"
        />
        <RefreshBtn @click="refresh" :loading="currenciesStore.isLoading" />
      </div>
          ...
          <template #body>
            <c-tr v-for="data in currenciesStore.data?.items" :key="data">
              ...
              >
                ...
                <div v-else-if="key.type === 'hex_color'">
                  <sm-btn
...
const currenciesStore = useCurrenciesStore(isActive.value.toString());
