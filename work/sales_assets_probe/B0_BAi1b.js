...
const filtersStore = useFiltersStore("access/warehouse");
...
const onApply = () => {
  warehouseStore.params.roleIds = filtersStore.selectedRoles.length
    ? filtersStore.selectedRoles
    : undefined;
  warehouseStore.params.rolePositionIds = filtersStore.selectedRolePositions
    .length
    ? filtersStore.selectedRolePositions
    : undefined;
  warehouseStore.params.isActive = filtersStore.selectedActiveStatus;
};
<\/script>
`;export{e as default};
