...
import { useClientFormatStore } from "~/stores/settings/client-format/client-format";
...
// Store
const clientFormatStore = useClientFormatStore("main");
...
const save = async () => {
  ...
  const res = await clientFormatStore.add(data.value);
  if (res !== "error") {
...
const getDetail = async () => {
  ...
  initialDetailData.value = await clientFormatStore.getDetail(props.id!);
