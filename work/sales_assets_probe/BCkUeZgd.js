const e=`<template>
  <side-menu
    ...
    variant="single"
    :data="data"
    :loading="warehouseStore.isWarehousesLoading"
    :classes="{
...
// Types
type Props = {
  data: (MenuBaseItem & AccessWarehouseModel)[];
};
