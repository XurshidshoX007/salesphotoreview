...
const filtersStore = useFiltersStore("access/branch");
...
const onApply = () => {
  branchStore.params.roleIds = filtersStore.selectedRoles.length
    ? filtersStore.selectedRoles
    : undefined;
  branchStore.params.rolePositionIds = filtersStore.selectedRolePositions.length
    ? filtersStore.selectedRolePositions
    : undefined;
  branchStore.params.isActive = filtersStore.selectedActiveStatus;
};
<\/script>
`;export{e as default};
